package com.example.customannotationexample.annotation.secret.aop;
...
public class SecretAOP {
    ...
    @Pointcut("@within(com.example.customannotationexample.annotation.secret.annotation.Secret) || @annotation(com.example.customannotationexample.annotation.secret.annotation.Secret)")
